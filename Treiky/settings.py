# Django settings for Treiky project.
...
SECRET_KEY = 'h&amp;8jb(r65(5#qtt&amp;y$xa0y6gjelu+7_zntn0f_fw26g_yc=rx4'
...
ROOT_URLCONF = 'Treiky.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'Treiky.wsgi.application'
